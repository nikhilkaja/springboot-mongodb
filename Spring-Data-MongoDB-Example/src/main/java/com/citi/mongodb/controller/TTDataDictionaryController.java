...
import com.citi.mongodb.dal.TTDataDictionaryRepository;
import com.citi.mongodb.exception.RecordNotFoundException;
import com.citi.mongodb.model.TTDataDictionaryEvar;

@RestController
@RequestMapping("/v1")
public class TTDataDictionaryController {
	
	private final Logger LOG = LoggerFactory.getLogger(getClass());
   
	@Autowired
    private TTDataDictionaryRepository ttDataDictionaryRepository;
